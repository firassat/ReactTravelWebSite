...
const MainNavbar = (props) => {
  ...
  const initialNavbarState = "main-navbar";
  ...
  return (
    <div
      className={
        navbarState === "sign-nav"
          ? "sign-nav"
          : navbarState === "main-navbar"
          ? "main-navbar"
          : "white-navbar"
      }
    >
      ...
      <div className="container">
        <div className="up-navbar">
          ...
          <div className="centring-flex">
            ...
            <div className={localStorage.getItem("token") ? "" : "hidden"}>
              ...
              {!profileImage && (
                <NavLink to="./profile" onClick={() => handleSignin()}>
                  {name}
                </NavLink>
              )}
            </div>
        ...
        <div
          className={navbarState === "main-navbar" ? "firstnav" : "secondnav"}
        >
          <NavLink to="hotels" onClick={() => handleLog()}>
            <span>{Lan("hotel")}</span>
            <div>
          ...
          <NavLink to="trips" onClick={() => handleLog()}>
            <span>{Lan("trips")}</span>
            <div>
              <GiCampingTent size="1.5em" />
            </div>
          </NavLink>
          <NavLink to="attractions" onClick={() => handleLog()}>
            <span>{Lan("attraction")}</span>
            <div>
              <GiPalmTree size="1.5em" />
            </div>
          </NavLink>
        </div>
      </div>
